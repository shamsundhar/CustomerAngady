...
public class ChangeLocationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ChangeLocationAdapter(CheckoutActivity checkoutActivity, List<Object> items){
        this.items = items;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        if(viewType == LIST_HEADER_ITEM){
            ...
            viewHolder = new ChangeLocationAdapter.ListHeaderViewHolder(v1);
        }
